    ...
    <form class="form-horizontal" method="post" action="<?php echo site_url('ShowCRUD/addShow'); ?>">
        <fieldset>
            ...
            <div class="form-group">
                ...
                <div class="col-md-9">
                    <input id="bname" name="bname" type="text" placeholder="Band Name" class="form-control input-md" value="<?php if(isset($info['array identifyer'])){echo $info['array identifyer'];}else{$nodata = "";echo $nodata;} ?>" required>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-md-9">
                    <input id="date" name="date" type="date" placeholder="Date" class="form-control input-md" value="<?php if(isset($info['array identifyer'])){echo $info['array identifyer'];}else{$nodata = "";echo $nodata;} ?>" required>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-md-9">
                    <input id="venue" name="venue" type="text" placeholder="Venue" class="form-control input-md" value="<?php if(isset($info['array identifyer'])){echo $info['array identifyer'];}else{$nodata = "";echo $nodata;} ?>" required>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-md-9">
                    <input id="address" name="address" type="text" placeholder="Address" class="form-control input-md" value="<?php if(isset($info['array identifyer'])){echo $info['array identifyer'];}else{$nodata = "";echo $nodata;} ?>" required>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-md-9">
                    <input id="city" name="city" type="text" placeholder="City" class="form-control input-md" value="<?php if(isset($info['array identifyer'])){echo $info['array identifyer'];}else{$nodata = "";echo $nodata;} ?>" required>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-md-9">
                    <input id="state" name="state" type="text" placeholder="State" class="form-control input-md" value="<?php if(isset($info['array identifyer'])){echo $info['array identifyer'];}else{$nodata = "";echo $nodata;} ?>" required>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-md-9">
                    <input id="zipcode" name="zipcode" type="text" placeholder="Zipcode" class="form-control input-md" value="<?php if(isset($info['array identifyer'])){echo $info['array identifyer'];}else{$nodata = "";echo $nodata;} ?>" required>
                </div>
            </div>
